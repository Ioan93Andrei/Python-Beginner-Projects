...
def gameOn():
  ...
  while True:
    ...
    player_choice = input("Please chose Rock/Paper/Scissors: ").lower()
    ...
    while True:
      ...
      if messages.win:
        input("Would you like to play again or see your score? Yes/No/Score ")
        
        if input in ("Score", "score"):
          print("Your total score is " + str(total_score)) 
          print("Game starting again!")
        elif input in ("yes", "Yes", "y", "Y", "yup"):
          print("Game starting again!")
        else:
          print("Goodbye!")
        break
